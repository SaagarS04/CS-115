...
# Input: n
# Assume: n >= 0
# Output: n values of fib sequence

0 read r1 #Get Input
1 setn r2 0 #Create variable with starting val 0
2 setn r3 1 #Create variable with starting val 1
3 setn r4 0 #Create variable with starting val 0
4 jeqzn r1 11 #Jump to end if n = 0
5 add r4 r3 r2 #Add the vals
6 write r2 #Print the current val
7 copy r2 r3 #Copy over the previous val
8 copy r3 r4 #Copy over the previous val
9 addn r1 -1 #Subtract 1 from n
10 jumpn 4 #Jump back to the check
11 halt
"""
